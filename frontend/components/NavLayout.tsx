...
const navItems = [
  { href: '/schedule', label: '課表',    icon: NAV_ICONS.schedule },
  { href: '/grades',   label: '成績',    icon: NAV_ICONS.grades },
  { href: '/absence',  label: '缺曠',    icon: NAV_ICONS.absence },
  { href: '/leaves',   label: '假單',    icon: NAV_ICONS.leaves },
  { href: '/chat',     label: 'AI 助理', icon: NAV_ICONS.chat },
