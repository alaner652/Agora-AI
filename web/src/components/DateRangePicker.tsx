...
const dateCls = 'bg-stone-800 border border-stone-700 text-stone-100 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400/50 w-full sm:w-auto'
const quickCls = 'text-xs text-orange-400 hover:text-orange-300 hover:underline transition-colors'
  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
        ...
        <span className="hidden sm:block text-stone-600 text-sm">—</span>
